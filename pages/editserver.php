...
<form action="inc/editserver.php" method="post">
    <table width="500">
		...
		<tr>
            ...
            <td><input type="text" class="form-control" name="servername" required="required" value="<?php echo $server_row[3]; ?>"/></td>
        </tr>
        <tr>
            <td align="right" class="col-lg-4 control-label"><b>Server IP</b></td>
            <td><input type="text" class="form-control" name="serverip" required="required" value="<?php echo $server_row[1]; ?>"/></td>
        </tr>
        <tr>
            <td align="right" class="col-lg-4 control-label"><b>Server port</b></td>
            <td><input type="text" class="form-control" name="serverport" required="required" value="<?php echo $server_row[2]; ?>"></td>
        </tr>
		<tr>
